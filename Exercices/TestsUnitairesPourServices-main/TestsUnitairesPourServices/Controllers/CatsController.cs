...
namespace TestsUnitairesPourServices.Controllers
{
    public class CatsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Cat != null ? 
                          ...
                          Problem("Entity set 'TestsUnitairesPourServicesContext.Cat'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age")] Cat cat)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age")] Cat cat)
        {
            if (id != cat.Id)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'TestsUnitairesPourServicesContext.Cat'  is null.");
            }
            var cat = await _context.Cat.FindAsync(id);
            if (cat != null)
            {
